...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><button type="button"class="btn btn-default">Select file to upload</button></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button' (click)= "check()" class='btn btn-danger glyphicon glyphicon-remove'><img src="assets/images/close.png"></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
            ...
            const disableMouseEvents = () => {
                ...
                dragbox.css("border-color", "#FE1743");
            ...
            button.mouseenter(function onMouseEnter(event) {
                button.css("background", "#FE1743").css("color", "white");
            }).mouseleave(function onMouseLeave() {
                button.css("background", "white").css("color", "#FE1743");
            });
